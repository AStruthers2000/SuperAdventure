...
namespace Engine
{
    public class Monster : LivingCreature
    {
        ...
        public Monster(Monster template, int currentHitPoints, int maximumHitPoints) : base(currentHitPoints, maximumHitPoints)
        {
            ID = template.ID;
            Name = template.Name;
            MaximumDamage = template.MaximumDamage;
            RewardExperiencePoints = template.RewardExperiencePoints;
